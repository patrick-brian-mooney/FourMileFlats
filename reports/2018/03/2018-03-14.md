...
<li><strong>06:15:00</strong> (problem level 3):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (mdev=536.298 ms; avg=238.646)</li>
 </ul>
</li>
...
<li><strong>08:55:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=407.361 ms; avg=144.523)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
 </ul>
</li>
...
<li><strong>10:15:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=461.843 ms; avg=179.220)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<li><strong>11:50:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=256.697 ms; avg=126.863)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<li><strong>12:15:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=472.676 ms; avg=164.014)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<li><strong>13:25:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 300% (mdev=867.878 ms; avg=268.540)</li>
 </ul>
</li>
...
<li><strong>14:55:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=218.923 ms; avg=89.889)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=5%)</li>
 </ul>
</li>
...
<li><strong>19:40:00</strong> (problem level 3):
 <ul>
  ...
  <li>Failed test: Jitter above 300% (mdev=686.452 ms; avg=227.791)</li>
 </ul>
</li>
...
<li><strong>21:35:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=402.527 ms; avg=167.429)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<li><strong>22:25:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=296.312 ms; avg=145.383)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
<li><strong>22:30:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Jitter above 200% (mdev=526.557 ms; avg=233.922)</li>
 </ul>
</li>
<li><strong>22:45:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Jitter above 200% (mdev=598.249 ms; avg=255.273)</li>
 </ul>
</li>
<li><strong>22:55:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Jitter above 200% (mdev=476.715 ms; avg=215.618)</li>
 </ul>
</li>
...
<li><strong>23:55:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Jitter above 200% (mdev=470.696 ms; avg=203.725)</li>
 </ul>
</li>
</ul>
...
<a href="reports/2018/03/2018-03-14-traceroute.md">Traceroute logs</a> were generated for this date.
