...
<li><strong>11:10:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=5%)</li>
  <li>Failed test: Jitter above 200% (mdev=282.275 ms; avg=119.184)</li>
 </ul>
</li>
...
<a href="reports/2018/03/2018-03-10-traceroute.md">Traceroute logs</a> were generated for this date.
