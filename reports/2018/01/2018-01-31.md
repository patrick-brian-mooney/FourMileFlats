...
<li><strong>06:40:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=175.085; mdev=435.029 ms)</li>
 </ul>
</li>
...
<li><strong>15:10:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Jitter above 200% (avg=208.765; mdev=434.738 ms)</li>
 </ul>
</li>
<li><strong>15:30:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Jitter above 200% (avg=229.874; mdev=634.148 ms)</li>
 </ul>
</li>
...
<li><strong>16:30:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Packet loss at least 1% (packet_loss=1%)</li>
  <li>Failed test: Jitter above 300% (avg=292.347; mdev=895.562 ms)</li>
 </ul>
</li>
...
<a href="reports/2018/02/2018-01-31-traceroute.md">Traceroute logs</a> were generated for this date.
