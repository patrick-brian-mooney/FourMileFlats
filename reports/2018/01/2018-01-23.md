...
# Network Quality Report for 2018-01-23

Today, <code>network-monitor</code> transmitted 25000 and received 24672 packets; that's an overall packet loss rate of 1.3120%. As of the end of data recording on that day, the test interval was 5 minutes and each test attempted to transmit 100 packets.

### Overall statistics for all ping tests:

<dl>
<dt>min</dt><dd>12.8000</dd>
<dt>avg</dt><dd>99.9603</dd>
<dt>max</dt><dd>5029.0000</dd>
<dt>std dev</dt><dd>215.6202</dd>
</dl>
...
<li><strong>05:35:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=188.352; mdev=428.518 ms)</li>
 </ul>
</li>
...
<li><strong>06:05:00</strong> (problem level 4):
 <ul>
  <li>Failed test: Packet loss at least 13% (packet_loss=14%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=300.985)</li>
 </ul>
</li>
...
<li><strong>06:45:00</strong> (problem level 3):
 <ul>
  ...
  <li>Failed test: Average packet RTT above 200 ms (avg=475.087)</li>
 </ul>
</li>
...
<li><strong>07:45:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=467.715)</li>
 </ul>
</li>
...
<li><strong>08:05:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=259.328)</li>
 </ul>
</li>
...
<li><strong>09:45:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=232.237; mdev=574.038 ms)</li>
 </ul>
</li>
...
<li><strong>11:05:00</strong> (problem level 3):
 <ul>
  <li>Failed test: Packet loss at least 6% (packet_loss=6%)</li>
  <li>Failed test: Jitter above 200% (avg=188.805; mdev=438.763 ms)</li>
 </ul>
</li>
<li><strong>11:15:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=263.980)</li>
  <li>Failed test: Jitter above 200% (avg=263.980; mdev=710.055 ms)</li>
 </ul>
</li>
...
<li><strong>11:50:00</strong> (problem level 3):
 <ul>
  <li>Failed test: Packet loss at least 6% (packet_loss=10%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=347.748)</li>
 </ul>
</li>
<li><strong>11:55:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=213.686)</li>
  <li>Failed test: Jitter above 200% (avg=213.686; mdev=452.660 ms)</li>
 </ul>
</li>
<li><strong>12:15:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=275.097)</li>
 </ul>
</li>
...
<li><strong>13:15:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=393.677)</li>
 </ul>
</li>
...
<li><strong>13:25:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=268.959)</li>
 </ul>
</li>
<li><strong>13:30:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=395.435)</li>
 </ul>
</li>
<li><strong>13:45:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=225.811)</li>
 </ul>
</li>
<li><strong>13:55:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=210.600)</li>
 </ul>
</li>
<li><strong>14:10:00</strong> (problem level 4):
 <ul>
...
<li><strong>14:55:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=5%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=252.054)</li>
 </ul>
</li>
<li><strong>15:25:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Average packet RTT above 200 ms (avg=204.033)</li>
 </ul>
</li>
...
<a href="reports/2018/01/2018-01-23-traceroute.md">Traceroute logs</a> were generated for this date.
