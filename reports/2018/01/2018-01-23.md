...
<li><strong>05:35:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (mdev=428.518 ms; avg=188.352)</li>
 </ul>
</li>
...
<li><strong>09:45:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (mdev=574.038 ms; avg=232.237)</li>
 </ul>
</li>
...
<li><strong>11:05:00</strong> (problem level 3):
 <ul>
  <li>Failed test: Packet loss at least 6% (packet_loss=6%)</li>
  <li>Failed test: Jitter above 200% (mdev=438.763 ms; avg=188.805)</li>
 </ul>
</li>
<li><strong>11:15:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (mdev=710.055 ms; avg=263.980)</li>
 </ul>
</li>
...
<li><strong>11:55:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (mdev=452.660 ms; avg=213.686)</li>
 </ul>
</li>
...
<a href="reports/2018/06/2018-01-23-traceroute.md">Traceroute logs</a> were generated for this date.
