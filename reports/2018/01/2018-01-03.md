...
<li><strong>10:10:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Packet loss at least 3% (packet_loss=5%)</li>
  <li>Failed test: Jitter above 200% (avg=491.204; mdev=1106.262 ms)</li>
 </ul>
</li>
...
<a href="reports/2018/01/2018-01-03-traceroute.md">Traceroute logs</a> were generated for this date.
