...
<li><strong>11:35:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=312.482; mdev=646.213 ms)</li>
 </ul>
</li>
...
<li><strong>14:55:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=348.115; mdev=813.221 ms)</li>
 </ul>
</li>
...
<li><strong>19:05:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=204.493; mdev=521.594 ms)</li>
 </ul>
</li>
...
<a href="reports/2018/01/2018-01-21-traceroute.md">Traceroute logs</a> were generated for this date.
