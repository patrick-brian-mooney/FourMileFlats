...
<li><strong>06:15:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=392.137 ms; avg=166.778)</li>
...
<li><strong>07:05:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=330.244 ms; avg=123.128)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<li><strong>07:35:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=410.189 ms; avg=139.941)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
 </ul>
</li>
...
<li><strong>07:55:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=222.358 ms; avg=103.477)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
 </ul>
</li>
<li><strong>09:45:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 300% (mdev=301.645 ms; avg=91.350)</li>
 </ul>
</li>
...
<li><strong>15:15:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 300% (mdev=464.899 ms; avg=146.911)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
<li><strong>15:35:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=244.265 ms; avg=89.048)</li>
  <li>Failed test: Packet loss at least 3% (packet_loss=5%)</li>
 </ul>
</li>
