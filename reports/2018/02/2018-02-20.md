...
# Network Quality Report for 2018-02-20

Today, <code>network-monitor</code> transmitted 25800 and received 25556 packets; that's an overall packet loss rate of 0.9457%. As of the end of data recording on that day, the test interval was 5 minutes and each test attempted to transmit 100 packets.

### Overall statistics for all ping tests:

<dl>
<dt>min</dt><dd>10.8000</dd>
<dt>avg</dt><dd>63.8737</dd>
<dt>max</dt><dd>4527.0000</dd>
<dt>std dev</dt><dd>127.2976</dd>
</dl>
...
<li><strong>11:10:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Jitter above 200% (mdev=388.954 ms; avg=177.180)</li>
...
<li><strong>16:15:01</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<li><strong>17:45:00</strong> (problem level 4):
 <ul>
...
<li><strong>19:35:01</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<li><strong>20:00:01</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<li><strong>22:05:01</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=5%)</li>
 </ul>
</li>
<li><strong>22:15:01</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
 </ul>
</li>
...
<a href="reports/2018/02/2018-02-20-traceroute.md">Traceroute logs</a> were generated for this date.
