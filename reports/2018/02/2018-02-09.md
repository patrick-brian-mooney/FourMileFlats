...
<li><strong>05:50:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=113.351; mdev=232.189 ms)</li>
 </ul>
</li>
<li><strong>05:55:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=238.910; mdev=651.808 ms)</li>
 </ul>
</li>
<li><strong>06:10:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Jitter above 200% (avg=151.918; mdev=377.039 ms)</li>
 </ul>
</li>
<li><strong>06:25:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Jitter above 200% (avg=156.173; mdev=385.378 ms)</li>
 </ul>
</li>
...
<li><strong>07:35:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Jitter above 200% (avg=113.893; mdev=276.411 ms)</li>
 </ul>
</li>
<li><strong>07:40:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Jitter above 200% (avg=196.098; mdev=534.058 ms)</li>
 </ul>
</li>
...
<li><strong>09:00:00</strong> (problem level 3):
 <ul>
  ...
  <li>Failed test: Jitter above 300% (avg=214.658; mdev=738.988 ms)</li>
 </ul>
</li>
<li><strong>10:30:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Jitter above 200% (avg=176.924; mdev=451.780 ms)</li>
 </ul>
</li>
<li><strong>10:35:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Jitter above 200% (avg=137.658; mdev=303.101 ms)</li>
 </ul>
</li>
...
<li><strong>10:50:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=3%)</li>
  <li>Failed test: Jitter above 200% (avg=168.371; mdev=414.230 ms)</li>
 </ul>
</li>
<li><strong>11:05:00</strong> (problem level 2):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=209.697; mdev=564.975 ms)</li>
 </ul>
</li>
<li><strong>11:20:00</strong> (problem level 3):
 <ul>
  ...
  <li>Failed test: Jitter above 200% (avg=292.422; mdev=782.264 ms)</li>
 </ul>
</li>
...
<li><strong>11:45:00</strong> (problem level 2):
 <ul>
  <li>Failed test: Packet loss at least 3% (packet_loss=4%)</li>
  <li>Failed test: Jitter above 200% (avg=178.520; mdev=485.185 ms)</li>
 </ul>
</li>
...
<a href="reports/2018/02/2018-02-09-traceroute.md">Traceroute logs</a> were generated for this date.
